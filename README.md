...
The PKHeX integration is intentionally process-based. The native app calls a .NET helper under [`tools/pkhex_bridge`](/Users/vanta/Desktop/title_screen_demo/pokemon-resort/tools/pkhex_bridge) through `SaveBridgeClient`.
